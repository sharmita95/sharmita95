...
class Bulk extends Abstract_Summary_Page implements Interface_Page {
	...
	public function register_meta_boxes() {
		if ( ! is_network_admin() ) {
			...
			$required_recheck_images       = Global_Stats::get()->is_outdated();
			$show_bulk_smush_inline_notice = $bg_optimization->can_use_background() && $bg_optimization->is_dead();
			// Do not show failed bulk smush inline notice when required re-check images.
			$show_bulk_smush_inline_notice = $show_bulk_smush_inline_notice && ! $required_recheck_images;
